...
## 4. Нет Яндекс.Метрики
- Проблем не обнаружено

## 5. Нет favicon
- Проблем не обнаружено

## 6. Нет Schema.org JSON-LD
- Проблем не обнаружено

## 7. Некорректный JSON в Schema.org
- Проблем не обнаружено

## 8. Нет телефона на странице
- Проблем не обнаружено

## 9. Остались плейсхолдеры
- Проблем не обнаружено

## 10. Title > 60 символов
- Проблем не обнаружено

## 11. Description > 160 символов
- Проблем не обнаружено

## 12. Дубли title
- Дублей не обнаружено

## 13. Дубли description
- Дублей не обнаружено
...
## 16. Потенциально сломанные внутренние ссылки
- Проблем не обнаружено
...
- (2x) Выезд инженера для сметы — 3 000–6 000 ₽, при заказе работ сумма возвращается
  - index.html
- (2x) Выезд инженера согласовываем в удобное время, обычно в течение 1–2 дней
  - index.html
- (2x) Выезд инженера оплачивается отдельно, но при заключении договора эта сумма возвращается
  - index.html
- (2x) Выезд инженера
  - krym/index.html
- (1x) выезд инженера на участок перед покупкой
  - blog/kak-vybrat-septik-dlya-chastnogo-doma-v-krymu/index.html
- (1x) Выезд специалиста на оценку — бесплатно при заказе монтажа
  - blog/septik-dlya-dachi-krym/index.html
- (1x) выезда сервиса по 4 000–6 000 ₽ плюс электричество
  - blog/septik-dlya-dachi-krym/index.html
- (1x) выезд стоит 4 000–6 000 ₽
  - blog/septik-ili-vygrebnaya-yama-krym/index.html
- (1x) выезде проверят состояние системы и дренажа
  - blog/septik-ili-vygrebnaya-yama-krym/index.html
- (1x) Выезд на участок
  - blog/septik-simferopol/index.html
- (1x) выезд, замер, земляные работы, доставка, трубы, дренаж, подключение, засыпка и запуск — всё, чтобы можно было сразу сливать стоки
  - blog/skolko-stoit-septik-pod-klyuch-krym/index.html
- (1x) Выезд и осмотр
  - blog/skolko-stoit-septik-pod-klyuch-krym/index.html
- (1x) выездная служба для откачки ила и плановой диагностики
  - blog/skolko-stoit-septik-pod-klyuch-krym/index.html
- (1x) выезд на участок и консультацию;
  - blog/ustanovka-septika-krym/index.html
- (1x) выезд на участок, потом расчёт, потом покупка
  - blog/zhibi-ili-plastik-septik-krym/index.html
- (1x) Выезд инженера и смета
  - index.html
...
- (1x) выезда инженера
  - uslugi/septiki/index.html
- (1x) Выезд инженера и сметный расчёт
  - uslugi/septiki/index.html
- (1x) Выезд и замер
  - uslugi/zabory/index.html

## 18. Рекомендации
- Привести все CSS/JS к единой версии `?v=17`.
- Добавить canonical и Метрику на служебные страницы: call, lead-magnet, spasibo.
- Укоротить title/description в блог-статьях, где > лимита.
- Добавить Schema.org на страницы услуг (`/uslugi/*`) и информационные страницы.
- Проверить и унифицировать формулировки про выезд инженера.
